...
gc.collect()        # delete unnecessary data in RAM
import logging
import dcf_77
import networking
import webserver
...
DIGIT_PIN = {
    "hour_tens": Pin(23, Pin.OUT),
    "hour_one": Pin(21, Pin.OUT),
    "minute_tens": Pin(2, Pin.OUT),
    "minute_one": Pin(14, Pin.OUT)
}

DOT_PIN = {
    "above": Pin(19, Pin.OUT),
    "below": Pin(4, Pin.OUT)
}
...
class Animation:
    def __init__(self, number_segment, logger):
    ...
    def show_all_numbers(self, time_per_number=1, color=(255, 255, 255)):
        for number in range(0, 10):
            self.number_segment.turn_off_all_segments()
