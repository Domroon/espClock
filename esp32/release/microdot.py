...
class Response():
    ...
    def __init__(self, body='', status_code=200, headers=None, reason=None):
        self.log = logging.Logger(logging.DEBUG)
    ...
    def write(self, stream):
        try:
            ...
            self.log.error("From Microdot Webserver:", e)
            self.log.warning("Ignore this Error for now")
...
class Microdot():
    ...
    def __init__(self):
        ...
        self.debug = False
        self.server = None
        self.log = logging.Logger(log_level=logging.DEBUG)
    ...
    def handle_request(self, sock, addr):
        ...
        try:
            ...
            self.log.error("From Microdot Webserver", exc)
